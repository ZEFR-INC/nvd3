...
nv.models.tooltip = function() {
  ...
  */
  ...
  var position = function() {
    //EDIT get the mouse position relative to the nvd3 element and set the tooltip to absolute
    var container = chartContainer ? chartContainer : document.body;
    var rect = container.getBoundingClientRect();
    return {
      left: d3.event.clientX - rect.left,
      top: d3.event.clientY - rect.top
    };
    //END EDIT
  };
  ...
  function initTooltip() {
    if (!tooltip) {
      ...
      //EDIT absolute position tooltip to work in modal
  ...
  function chart(selection) {
    ...
    selection.each(function(data) {
      ...
      interactiveLayer.dispatch.on('elementMousemove', function(e) {
        ...
        if (postMarkerTooltip) obj.postMarkerTooltip = postMarkerTooltip;
        interactiveLayer.tooltip
          .chartContainer(that.parentNode)
          .valueFormatter(function(d,i) {
